...
test('parses report period', () => {
  ...
  assert.equal(parseReportPeriod('某基金2025年年报', '2026-01-01'), '2025FY');
});
...
过去一年 17.04% 1.18% 19.52% 1.19% -2.48% -0.01%`;
  ...
  assert.equal(parsed.period1y.trackingDifference, -2.48);
  assert.equal(parsed.validation.period1y, true);
});
