...
import { formatMarketRefreshClockTime, formatMarketRefreshTime, parseMarketRefreshTimestamp } from '../src/pages/markets/marketRefreshTime.js';
...
test('market refresh time formats source timestamps in Shanghai time', () => {
  ...
  assert.equal(formatMarketRefreshClockTime('2026-09-14T09:30:00+08:00'), '09:30:00');
...
test('market refresh time safely handles missing or invalid timestamps', () => {
  ...
  assert.equal(formatMarketRefreshClockTime('not-a-date'), '');
