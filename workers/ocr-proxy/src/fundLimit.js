...
// 标题筛选正则：匹配一切跟「大额申购 / 限额 / 金额限制 / 限购 / 暂停申购 / 恢复申购 / 调整大额 / 大额定投」相关的标题。
// 备注：不少基金公告标题使用「金额限制」而非「限额」，需要覆盖。
const ANNOUNCEMENT_TITLE_PATTERN = /(?:调整|限制|限购|暂停|恢复|开放|限制)?大额(?:申购|定投|定期定额)|限额申购|金额限制|暂停申购|恢复申购|限额业务|调整申购/;
