      ...
      <div className="flex flex-wrap gap-2">
        ...
        {suggestions.map((sug, idx) => (
          <button
            key={idx}
            type="button"
            className="inline-flex items-center gap-1.5 rounded-lg bg-white px-3 py-1.5 text-xs font-medium text-[var(--brand-text)] ring-1 ring-[var(--brand-text)] transition-colors hover:bg-[var(--brand-tint)]"
