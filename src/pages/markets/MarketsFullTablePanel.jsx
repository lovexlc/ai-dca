...
export function MarketsFullTablePanel({
  ...
  const renderMobileTableRow = (row) => {
    ...
    const values = {
      ...
      updatedAt: <span className="tabular-nums">{resolveMarketUpdatedAt(row) || '—'}</span>,
  ...
  return (
    <div className="market-desktop-panel hidden h-full min-h-0 flex-1 flex-col overflow-hidden lg:flex">
      ...
      <MarketListTable
        ...
        dataTableContainerClassName="market-desktop-table-scroll min-h-0 flex-1 overflow-auto rounded-none border-x-0 border-b-0"
        autoPinColumn
