...
const API_ORIGIN = String(VITE_ENV.VITE_API_ORIGIN || '').replace(/\/$/, '');
const MARKETS_API_ORIGIN = String(VITE_ENV.VITE_MARKETS_API_ORIGIN || '').replace(/\/$/, '');
const NOTIFY_API_ORIGIN = String(VITE_ENV.VITE_NOTIFY_API_ORIGIN || '').replace(/\/$/, '');
const SYNC_API_ORIGIN = String(VITE_ENV.VITE_SYNC_API_ORIGIN || '').replace(/\/$/, '');
