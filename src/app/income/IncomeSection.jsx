...
const PAGE_BY_ROUTE = {
	[ROUTES.INCOME]: lazy(() => import('./IncomeDetailPage.jsx')),
	// 4.1: 旧子路由 alias 到收益明细（曲线 + 日历已内嵌）
	[ROUTES.CHART]: lazy(() => import('./IncomeDetailPage.jsx')),
	[ROUTES.CALENDAR]: lazy(() => import('./IncomeDetailPage.jsx')),
	[ROUTES.LIQUIDATION]: lazy(() => import('./IncomeLiquidationPage.jsx')),
	[ROUTES.BREAKDOWN]: lazy(() => import('./IncomeBreakdownPage.jsx')),
	...
	[ROUTES.TRANSACTIONS]: lazy(() => import('./IncomeTransactionsPage.jsx')),
};
