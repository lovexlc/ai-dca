  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'markets-detail-sheet fixed z-[111] flex w-full flex-col gap-4 border-[var(--a-200)] bg-[var(--bg-100)] p-5 text-[var(--fg-1000)] outline-none sm:max-w-md',
      ...
      >
        ...
        {showCloseButton ? (
          <DialogPrimitive.Close
            className="absolute right-4 top-4 inline-flex h-8 w-8 items-center justify-center rounded-md text-[var(--fg-700)] hover:bg-[var(--market-surface-subtle)] hover:text-[var(--fg-1000)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--market-accent)]"
            aria-label="关闭"
          >
